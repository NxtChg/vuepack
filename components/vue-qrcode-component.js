...
Vue.component('qr-code',
{
	...
	props:
	{
		...
		{
			type: String,
			validator: function(v){ return (v == 'L' || v == 'M' || v == 'Q' || v == 'H'); },
			required: false,
			default: 'H'
		}
	},
	...
	watch:
	{
		text: function(){ this.clear(); this.makeCode(this.text); }
	},
	
	data: function(){ return { qrCode: {} }; },
	
	mounted: function()
	{
		this.qrCode = new QRCode(this.$el,{ text: this.text, width: this.size, height: this.size, colorDark: this.color, colorLight: this.bgColor, correctLevel: QRCode.CorrectLevel[this.errorLevel]});
	},
	
	methods:
	{
 		clear: function(){ this.qrCode.clear(); },

		makeCode: function(text){ this.qrCode.makeCode(text); }
	}
});
